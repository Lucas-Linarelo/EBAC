...
const dataEvento = new Date("Dec 12, 2025 19:00");
...
const contaHora = setInterval(function(){
    ...
    document.getElementById('contador').innerHTML = `O maior evento de tecnologia do Brasil começa em ${diasAteEvento}d ${horasAteEvento}h ${minutosAteEvento}m ${segundoAteEvento}s`
